...
public class CommandSwerveDrivetrain extends SwerveDrivetrain implements Subsystem {
   ...
   /* public AutoBuilder autoBuilder=new AutoBuilder().configure(
        getPose2d(),
        resetPose(),
        getChassisSpeeds(),
        setChassisSpeeds(),
    ...
    public void setChassisSpeeds(){
        /*this.applyRequest(new SwerveRequest() {
            
        })*/
    }

    public Supplier<Pose2d> getPose2d(){
        Supplier<Pose2d> supplier=() -> this.getState().Pose;

        return supplier;
    }

    public Supplier<ChassisSpeeds> getChassisSpeeds(){
        Supplier<ChassisSpeeds> supplier=() -> this.getState().Speeds;
