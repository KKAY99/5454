...
import frc.robot.swervelib.math.SwerveKinematics2;
...
public class SwerveDrive {
 ...
 //   if(DriverStation.getAlliance().get()==Alliance.Red){
   ...
   if (SwerveDriveTelemetry.verbosity == TelemetryVerbosity.HIGH) {
    ...
    //System.out.println("0-"+  swerveModuleStates[0].angle.getDegrees());
   // System.out.println("1-"+  swerveModuleStates[1].angle.getDegrees());
   // System.out.println("2-"+  swerveModuleStates[2].angle.getDegrees());
   // System.out.println("3-required module state"+  swerveModuleStates[3].angle.getDegrees());
  ...
  public void updateOdometry() {
    ...
    for (SwerveModule module : swerveModules) {
        ...
        SmartDashboard.putNumber(
            "Module" + module.moduleNumber + "Angle", module.getState().angle.getDegrees());
      }
