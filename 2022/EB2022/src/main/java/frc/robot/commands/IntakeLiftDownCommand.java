...
public class IntakeLiftDownCommand extends CommandBase {
   ...
   */
  public IntakeLiftDownCommand(IntakeLiftSubsystem intakeLiftSubsytem,final double targetSpeed) {
  ...
  public boolean isFinished() {
    System.out.println("Down Is Finished = " + m_subsystem.isLowerSwitchSet());
   
    return m_subsystem.isLowerSwitchSet();
  }
}
