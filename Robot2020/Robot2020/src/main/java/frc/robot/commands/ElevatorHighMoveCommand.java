...
public class ElevatorHighMoveCommand extends CommandBase {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  private final double m_targetSpeed;
  private final ElevatorSubSystemHigh m_subsystem;
  /**
    * @param targetSpeed The speed we are setting in execute
   */
  public ElevatorHighMoveCommand(ElevatorSubSystemHigh subsystem,final double targetSpeed) {
