...
public class ShooterComboCommand extends CommandBase {
   ...
   */
  public ShooterComboCommand(ElevatorSubSystemHigh highSubsystem,ElevatorSubSystemLow lowSubsystem,ShooterSubsystem shooterSubsystem,double targetSpeed) {
