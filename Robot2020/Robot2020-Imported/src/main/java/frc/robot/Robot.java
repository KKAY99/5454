...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    m_autoChooser.setDefaultOption("Shoot and Drive", AutoModes.autoShootandMove);
    m_autoChooser.addOption("Drive", AutoModes.autoMove);
    m_autoChooser.addOption("Wait-Shoot-Drive",AutoModes.autoDelayShootandMove);
    m_autoChooser.addOption("Wait-Drive",AutoModes.autoDelayMove) ;  
    m_autoChooser.addOption("Shoot Only",AutoModes.autoShoot);    
  ...
  public void robotPeriodic() {
    ...
    System.out.println("Sonar Range - " + m_Ultrasonic.getRangeInches());
    System.out.println("Sonar Valid - " + m_Ultrasonic.isRangeValid());
  ...
  public void autonomousPeriodic() {
    ...
    SmartDashboard.putNumber("GyroSpeed", m_Gyro.getRate());
