...
public class xNotInUseShooterSubsystemVelocity implements Subsystem {
...
public static double[] distanceValues = {
  ...
  public xNotInUseShooterSubsystemVelocity(Integer BottomPort, Integer TopPort,double primeSpeed) {
