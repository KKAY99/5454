...
public class Limelight {
    ...
    private static double[] distanceValues = new double[] { ShooterSubsystemVoltage.distanceValues[0],
            ShooterSubsystemVoltage.distanceValues[ShooterSubsystemVoltage.distanceValues.length - 1] };
