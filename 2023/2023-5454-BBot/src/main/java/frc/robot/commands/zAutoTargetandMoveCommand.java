...
public zAutoTargetandMoveCommand(Limelight limelight,DrivetrainSubsystem drive,int gridChoice,XboxController driver){
        ...
        m_pipeline=Constants.ChargedUp.BottomTapePipeline;
    ...
    public boolean isFinished() {
      ...
      if((Math.abs(m_driver.getLeftX())>Constants.ChargedUp.swerveDeadband*2) || (Math.abs(m_driver.getLeftY())>Constants.ChargedUp.swerveDeadband*2)) {
