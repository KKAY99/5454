...
public class ShooterSubsystem{
  ...
  public static final double shootLowSpeed=0.45;
  public static final double shootMediumSpeed=0.6;
  public static final double shootHighSpeed=0.70;
  public static final double shootSuperSpeed=0.90;
  public static final double delayLowShot=1.5;
  public static final double delayMediumShot=1.00;
  public static final double delayHighShot=1.25;
