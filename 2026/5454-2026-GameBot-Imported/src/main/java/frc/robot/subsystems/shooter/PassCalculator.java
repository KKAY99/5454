...
//calculate with different shot maps for passing
...
public class PassCalculator {
  private static PassCalculator instance;
  ...
  public static PassCalculator getInstance() {
    if (instance == null) instance = new PassCalculator();
    return instance;
  }
