...
public class TunerConstantsOldA {
    ...
    public static final double kAutoMaxAngularSpeed=4.5; //was 6.5 changed to hopefully fix the auto
    ...
    private static final SwerveModuleConstantsFactory<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> ConstantCreator =
     ...
     private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.078857421875);
