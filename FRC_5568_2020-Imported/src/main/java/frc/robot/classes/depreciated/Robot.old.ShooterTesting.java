...
// import frc.robot.classes.drives.oldswerve.SwerveDrive;
...
//         static NetworkTableEntry networkTableEntryShooterSpeed = SubSystems.add("Shooter Encoder Speed", 0)
...
//         static NetworkTableEntry networkTableEntryShooterPower = SubSystems.add("Shooter Power", 0)
//                         .withWidget(BuiltInWidgets.kNumberBar).withSize(2, 2).getEntry();
...
//                 networkTableEntryShooterPower.setDouble(shooterPower * 100);
//                 networkTableEntryShooterSpeed.setDouble(m_Shooter.getEncoderSpeed() * 2.0);
...
//                 if (m_joystickRight.getRawButtonReleased(11)) {
//                         shooterPower += 0.002;
//                 } else if (m_joystickRight.getRawButtonReleased(10)) {
//                         shooterPower -= 0.002;
//                 }
...
//                         // Shooter Motor
//                         m_Shooter.voltageRun(shooterPower);
