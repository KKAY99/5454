...
//                 networkTableEntryFrontLeftEncoderActual.setDouble(m_FrontLeftModule.getSteerEncoderActual());
//                 networkTableEntryFrontRightEncoderActual.setDouble(m_FrontRightModule.getSteerEncoderActual());
//                 networkTableEntryBackLeftEncoderActual.setDouble(m_BackLeftModule.getSteerEncoderActual());
//                 networkTableEntryBackRightEncoderActual.setDouble(m_BackRightModule.getSteerEncoderActual());

//                 networkTableEntryFrontLeftEncoderTarget.setDouble(m_FrontLeftModule.getSteerEncoderTarget());
//                 networkTableEntryFrontRightEncoderTarget.setDouble(m_FrontRightModule.getSteerEncoderTarget());
//                 networkTableEntryBackLeftEncoderTarget.setDouble(m_BackLeftModule.getSteerEncoderTarget());
//                 networkTableEntryBackRightEncoderTarget.setDouble(m_BackRightModule.getSteerEncoderTarget());

//                 frontLeftAngle.setDouble(m_FrontLeftModule.getState().angle.getDegrees());
//                 frontRightAngle.setDouble(m_FrontRightModule.getState().angle.getDegrees());
//                 backLeftAngle.setDouble(m_BackLeftModule.getState().angle.getDegrees());
//                 backRightAngle.setDouble(m_BackRightModule.getState().angle.getDegrees());
...
//                 m_Drive.driveWithJoystick(rotateClockwise, forward, strafe, fieldCentric, false);
...
//                         m_Intake.lower();
//                 } else if (m_joystickRight.getRawButton(9) || gamepadRightBumper || m_joystickLeft.getRawButton(4)
