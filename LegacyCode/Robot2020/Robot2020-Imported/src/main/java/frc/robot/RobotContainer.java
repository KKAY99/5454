...
public class RobotContainer {
  ...
  public RobotContainer() {
   ...
   m_RobotDrive.setDefaultCommand(new DefaultDrive(m_RobotDrive,()-> -m_xBox.getRawAxis(1),()-> -m_xBox.getRawAxis(5)));
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(m_leftJoystick,Constants.ButtonConstants.TestTurnLeft).whenPressed(new TurnRobot(m_RobotDrive,.40,-20));
    new JoystickButton(m_leftJoystick,Constants.ButtonConstants.TestTurnRight).whenPressed(new TurnRobot(m_RobotDrive,.40,20));
  ...
  public Command getAutonomousCommand(Integer selectedMode) {
    ...
    if  (selectedMode==AutoModes.autoShootandMove){
      ...
      autoCommand=new DriveRobotCommand(m_RobotDrive,0,autoDriveSpeed,autoDriveDuration);
    }
      ...
      //autoCommand=new DriveRobotCommand(m_RobotDrive,0,autoNoMove,autoNoMove);
     autoCommand=new AutoNav(m_RobotDrive,0);
    }
       else {
      autoCommand=new DriveRobotCommand(m_RobotDrive,0, autoDriveSpeed,autoDriveDuration); 
    }
