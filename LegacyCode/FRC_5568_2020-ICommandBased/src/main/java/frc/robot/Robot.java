...
//        SwerveModule m_BackRightModule;
        ...
        public void teleopPeriodic() {
                ...
                if (m_joystickLeft.getRawButton(8)){
                        m_Drive.moveWheel(SwerveModules.kFrontLeft,0.9);
                      //  m_Drive.driveWithJoystick(0,.2,0,false,false);
                        }
                else{
                //       m_Drive.moveWheel(SwerveModules.kFrontLeft,0.0);
                }
                
                if (m_joystickLeft.getRawButton(9)){
                                m_Drive.moveWheel(SwerveModules.kBackLeft,0.9);
                        }
                        else{
                ...
                if (m_joystickLeft.getRawButton(10)){
                        m_Drive.moveWheel(SwerveModules.kFrontRight,0.9);
                                }
                        else{
                    //    m_Drive.moveWheel(SwerveModules.kFrontRight,0.0);
                        }
                        
                if (m_joystickLeft.getRawButton(11)){
                                m_Drive.moveWheel(SwerveModules.kBackRight,0.9);
                        }
                        else{
