...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_RobotDrive.setDefaultCommand(new DefaultDriveCommand(m_RobotDrive,()->m_xBoxDriver.getY(InputControllers.xBoxJoystickDrive),()->m_xBoxDriver.getX(InputControllers.xBoxJoystickDrive),()->m_xBoxDriver.getX(InputControllers.xBoxJoystickRotate)));    
