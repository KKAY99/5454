...
public class DefaultDriveCommand extends CommandBase {
  ...
  public DefaultDriveCommand(SwerveSubsystem subsystem, DoubleSupplier drive_fwd, DoubleSupplier drive_strafe,DoubleSupplier drive_rcw) {
    m_drive = subsystem;
  ...
  public void execute() {
    ...
    m_drive.drive(m_drive_fwd.getAsDouble() * Constants.kSpeedMultiplier, m_drive_strafe.getAsDouble() *Constants.kSpeedMultiplier, m_drive_rcw.getAsDouble() *Constants.kSpeedMultiplier) ;
