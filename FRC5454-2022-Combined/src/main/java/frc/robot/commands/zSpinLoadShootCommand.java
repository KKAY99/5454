...
public class zSpinLoadShootCommand extends CommandBase {
    ...
    public zSpinLoadShootCommand(ShooterSubsystem shooter, ConveyorSubsystem conveyor, FeederSubsystem feeder,
            double topSpeed, double bottomSpeed, double minVelocity) {
        m_shooter = shooter;
        m_conveyor = conveyor;
        m_feeder = feeder;
        m_topSpeed = topSpeed;
    ...
    public void execute() {
        ...
        } while (m_shooter.getBottomMotorVelocity() <= m_minVelocity
                | m_shooter.getBottomMotorVelocity() <= m_minVelocity);
