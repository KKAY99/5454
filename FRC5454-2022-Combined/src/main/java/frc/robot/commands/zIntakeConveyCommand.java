...
public class zIntakeConveyCommand extends CommandBase {
    ...
    public zIntakeConveyCommand(IntakeSubsystem intake, IntakeSubsystem intakeInner, double intakeSpeed,
            ConveyorSubsystem conveyor, double conveyorSpeed, FeederSubsystem feeder, double feederSpeed) {
        m_conveyor = conveyor;
        m_feeder = feeder;
        m_intake = intake;
