...
public class OnboardPidSwerveModule extends SwerveModule {
    ...
    /**
     * @param positionOffset    the modules offset from the robot's center of
     *                          rotation in inches
     ...
     * @param angleEncoder      a supplier that will return the module angle encoder
     *                          value in radians
     * @param driveEncoder      a supplier that will return the module drive encoder
     *                          value in inches
     * @param anglePidConstants the pid constants used for the the angle pid
     *                          controller
     */
    ...
    /**
     * Sets the hardware update thread rate. The default rate is
     * {@value #DEFAULT_HARDWARE_UPDATE_RATE}.
     *
     * @param updateRate the rate in hertz that the hardware update thread should
     *                   run.
     */
    ...
    /**
     * Gets the current rate that the hardware update thread is running at. This is
     * not the rate specified by
     * {@link #setHardwareUpdateRate(double)} but instead is determined by how fast
     * the hardware thread is currently
     * running.
     *
