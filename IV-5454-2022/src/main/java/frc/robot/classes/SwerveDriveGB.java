...
public class SwerveDriveGB {
    ...
    public SwerveDriveGB(AHRS ahrs){
        ...
        // #endregion
        SwerveDriveInit(FrontLeftSteering,FrontRightSteering,BackLeftSteering,BackRightSteering,FrontLeftDrive,FrontRightDrive,BackLeftDrive,BackRightDrive,ahrs);
    }
    ...
    private void SwerveDriveInit(TalonSRX motorFrontLeftSteering, TalonSRX motorFrontRightSteering,
        ...
        m_SrxFrontLeftSteering.configAllowableClosedloopError(Constants.SwerveDriveGB.kAlloweedError, Constants.SwerveDriveGB.kPIDLoopIdx,
                Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxFrontRightSteering.configAllowableClosedloopError(Constants.SwerveDriveGB.kAlloweedError, Constants.SwerveDriveGB.kPIDLoopIdx,
                Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackLeftSteering.configAllowableClosedloopError(Constants.SwerveDriveGB.kAlloweedError, Constants.SwerveDriveGB.kPIDLoopIdx,
                Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackRightSteering.configAllowableClosedloopError(Constants.SwerveDriveGB.kAlloweedError, Constants.SwerveDriveGB.kPIDLoopIdx,
                Constants.SwerveDriveGB.kTimeoutMs);

        // Configure the overloop behavior of the encoders
        m_SrxFrontLeftSteering.configFeedbackNotContinuous(Constants.SwerveDriveGB.kNonContinuousFeedback, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxFrontRightSteering.configFeedbackNotContinuous(Constants.SwerveDriveGB.kNonContinuousFeedback, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackLeftSteering.configFeedbackNotContinuous(Constants.SwerveDriveGB.kNonContinuousFeedback, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackRightSteering.configFeedbackNotContinuous(Constants.SwerveDriveGB.kNonContinuousFeedback, Constants.SwerveDriveGB.kTimeoutMs);

        /* Config Position Closed Loop gains in slot0, typically kF stays zero. */
        // Front Left
        m_SrxFrontLeftSteering.config_kF(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kF, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxFrontLeftSteering.config_kP(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kP, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxFrontLeftSteering.config_kI(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kI, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxFrontLeftSteering.config_kD(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kD, Constants.SwerveDriveGB.kTimeoutMs);
        // Front Right
        m_SrxFrontRightSteering.config_kF(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kF, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxFrontRightSteering.config_kP(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kP, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxFrontRightSteering.config_kI(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kI, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxFrontRightSteering.config_kD(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kD, Constants.SwerveDriveGB.kTimeoutMs);
        // Back Left
        m_SrxBackLeftSteering.config_kF(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kF, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackLeftSteering.config_kP(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kP, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackLeftSteering.config_kI(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kI, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackLeftSteering.config_kD(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kD, Constants.SwerveDriveGB.kTimeoutMs);
        // Back Right
        m_SrxBackRightSteering.config_kF(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kF, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackRightSteering.config_kP(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kP, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackRightSteering.config_kI(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kI, Constants.SwerveDriveGB.kTimeoutMs);
        m_SrxBackRightSteering.config_kD(Constants.SwerveDriveGB.kPIDLoopIdx, Constants.SwerveDriveGB.kGains.kD, Constants.SwerveDriveGB.kTimeoutMs);
    }
    ...
    { double FWD=0;
      ...
      double RCW=0;
        ...
        }else if(Math.abs(distanceGap)>Constants.SwerveDriveGB.kVisionDistanceTolerance){
            if (distanceGap>0){
