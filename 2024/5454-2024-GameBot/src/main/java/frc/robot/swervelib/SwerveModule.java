...
public class SwerveModule {
  ...
  public void setDesiredState(SwerveModuleState2 desiredState, boolean isOpenLoop, boolean force) {
    ...
    //System.out.println("last angle " + lastAngle + " new angle" + angle + "SyncEncQ" + synchronizeEncoderQueued);
      ...
      if (absoluteEncoder != null && synchronizeEncoderQueued) {
        ...
        //System.out.println("abs: "+ absoluteEncoderPosition + "  nxt: "+     Math.toDegrees(desiredState.omegaRadPerSecond));
