...
// π/180
private static final double FRONT_LEFT_ANGLE_OFFSET = -0; ///-0.850

//private static final double FRONT_RIGHT_ANGLE_OFFSET = 3.29; //0.25; //-4.72+3.04;//-1.45
private static final double FRONT_RIGHT_ANGLE_OFFSET = 0; //0.25; //-4.72+3.04;//-1.45
...
private static final double BACK_LEFT_ANGLE_OFFSET = 0;//-77+3.04;//-0.78

//private static final double BACK_RIGHT_ANGLE_OFFSET =-2.17-3.04; //-2.42-3.04
private static final double BACK_RIGHT_ANGLE_OFFSET =0; //-2.42-3.04
